...
<template>
  <div
    v-if="openStatus"
    class="fixed left-1/2 top-1/2 z-50 flex h-[calc(100%-1rem)] max-h-full w-full overflow-y-auto overflow-x-hidden p-4 md:inset-0"
  >
    <div class="relative m-auto max-h-full w-full max-w-2xl">
      <!-- Modal content -->
