...
<template>
  <transition name="fade">
    <div
      ...
      tabindex="-1"
      aria-hidden="true"
      class="fixed left-1/2 top-1/2 z-50 flex h-full max-h-full w-full overflow-y-auto overflow-x-hidden p-4 md:inset-0"
    >
      ...
      <div
        @click="$emit('closeModal')"
        class="absolute inset-0 z-0 bg-black opacity-10"
      ></div>
    </div>
  </transition>
</template>
